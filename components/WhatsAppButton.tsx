...
const WHATSAPP_NUMBER = '19082280973';

const MESSAGES = {
  es: 'Hola, vi su página web y me interesa cotizar un seguro. ¿Me puede ayudar?',
  en: "Hi! I saw your insurance website and I'd like to get a quote. Can you help me?",
};
...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Pulse ring — animates every 3 s, subtle */}
      <span
