          ...
          <div className="max-w-5xl mx-auto px-5 lg:px-8 py-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-slate-400 font-light">Seguros para la comunidad hispana · Sin SSN · ITIN aceptado</p>
              </div>
              <div className="flex items-center gap-4 flex-wrap">
                <Link href="/" className="text-xs text-slate-400 hover:text-white transition-colors">Inicio</Link>
                <Link href="/seguros/mascotas" className="text-xs text-slate-400 hover:text-white transition-colors">Mascotas</Link>
                <button
                  onClick={() => setQuoteOpen(true)}
