...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${BASE}/${params.lang}/seguros/paquete-casa-auto`, languages: { 'es-US': `${BASE}/es/seguros/paquete-casa-auto`, 'en-US': `${BASE}/en/seguros/paquete-casa-auto`, 'x-default': `${BASE}/es/seguros/paquete-casa-auto` } },
    openGraph: { title: isEn ? 'Home + Auto Bundle for Hispanics | Maria Fernanda' : 'Paquete Seguro Casa + Auto para Hispanos | Maria Fernanda', description: isEn ? 'Bundle and save up to 25%. No SSN. ITIN accepted.' : 'Combina y ahorra hasta 25%. Sin SSN. ITIN aceptado.', url: `${BASE}/${params.lang}/seguros/paquete-casa-auto`, siteName: 'Maria Fernanda Insurance Consulting', locale: isEn ? 'en_US' : 'es_US', type: 'website' },
