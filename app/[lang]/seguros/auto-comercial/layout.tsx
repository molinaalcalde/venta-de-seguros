...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: isEn ? `${BASE}/en/commercial-auto` : `${BASE}/es/seguros/auto-comercial`, languages: { 'es-US': `${BASE}/es/seguros/auto-comercial`, 'en-US': `${BASE}/en/commercial-auto`, 'x-default': `${BASE}/es/seguros/auto-comercial` } },
    openGraph: { title: isEn ? 'Commercial Auto Insurance for Hispanic Contractors | Maria Fernanda' : 'Seguro Auto Comercial para Contratistas Hispanos | Maria Fernanda', description: isEn ? 'Vans, trucks, fleets. No SSN. COI in 24 hours. From $110/mo.' : 'Vans, camiones y flotas. Sin SSN. COI en 24 horas. Desde $110/mes.', url: isEn ? `${BASE}/en/commercial-auto` : `${BASE}/es/seguros/auto-comercial`, siteName: 'Maria Fernanda Insurance Consulting', locale: isEn ? 'en_US' : 'es_US', type: 'website' },
