...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: isEn ? `${BASE}/en/health-insurance` : `${BASE}/es/seguros/salud`, languages: { 'es-US': `${BASE}/es/seguros/salud`, 'en-US': `${BASE}/en/health-insurance`, 'x-default': `${BASE}/es/seguros/salud` } },
    openGraph: { title: isEn ? 'Health Insurance for Immigrants Without SSN | Maria Fernanda' : 'Seguro de Salud para Inmigrantes sin SSN | Maria Fernanda', description: isEn ? 'Individual and family plans. ITIN accepted. No SSN. From $199/mo.' : 'Planes individuales y familiares. ITIN aceptado. Sin SSN. Desde $199/mes.', url: isEn ? `${BASE}/en/health-insurance` : `${BASE}/es/seguros/salud`, siteName: 'Maria Fernanda Insurance Consulting', locale: isEn ? 'en_US' : 'es_US', type: 'website' },
