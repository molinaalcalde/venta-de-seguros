...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${BASE}/${params.lang}/seguros/dental`, languages: { 'es-US': `${BASE}/es/seguros/dental`, 'en-US': `${BASE}/en/seguros/dental`, 'x-default': `${BASE}/es/seguros/dental` } },
    openGraph: { title: isEn ? 'Dental Insurance for Immigrants Without SSN | Maria Fernanda' : 'Seguro Dental para Inmigrantes sin SSN | Maria Fernanda', description: isEn ? 'From $19/mo. No SSN. ITIN accepted.' : 'Desde $19/mes. Sin SSN. Acepta ITIN.', url: `${BASE}/${params.lang}/seguros/dental`, siteName: 'Maria Fernanda Insurance Consulting', locale: isEn ? 'en_US' : 'es_US', type: 'website' },
