...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${BASE}/${params.lang}/seguros/proteccion-extra`, languages: { 'es-US': `${BASE}/es/seguros/proteccion-extra`, 'en-US': `${BASE}/en/seguros/proteccion-extra`, 'x-default': `${BASE}/es/seguros/proteccion-extra` } },
    openGraph: { title: isEn ? 'Umbrella Coverage for Hispanics | Maria Fernanda' : 'Protección Extra (Umbrella) para Hispanos | Maria Fernanda', description: isEn ? 'From $1M additional coverage. Protects your savings. From $19/mo. No SSN required.' : 'Desde $1M de cobertura adicional. Protege tus ahorros. Desde $19/mes. Sin SSN requerido.', url: `${BASE}/${params.lang}/seguros/proteccion-extra`, siteName: 'Maria Fernanda Insurance Consulting', locale: isEn ? 'en_US' : 'es_US', type: 'website' },
