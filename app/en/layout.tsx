...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Maria Fernanda Insurance Consulting | Bilingual Insurance — No SSN Required',
  ...
  openGraph: {
    title: 'Maria Fernanda Insurance Consulting | Bilingual Insurance — ITIN Accepted',
    description:
  ...
  twitter: {
    ...
    title: 'Maria Fernanda Insurance Consulting | Bilingual Insurance',
    description:
