...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Seguro de Salud para Inmigrantes sin SSN | Maria Fernanda', description: 'Planes de salud individuales y familiares. ITIN aceptado. Sin SSN. Desde $199/mes.', url: `${BASE}/seguros/salud`, siteName: 'Maria Fernanda Insurance Consulting', locale: 'es_US', type: 'website' },
