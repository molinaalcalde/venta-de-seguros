...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Seguro Auto Comercial para Contratistas Hispanos | Maria Fernanda', description: 'Vans, camiones y flotas. Sin SSN. COI en 24 horas. Desde $110/mes.', url: `${BASE}/seguros/auto-comercial`, siteName: 'Maria Fernanda Insurance Consulting', locale: 'es_US', type: 'website' },
