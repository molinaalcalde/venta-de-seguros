...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Seguro Comercial para Negocios Hispanos sin SSN | Maria Fernanda', description: 'BOP, responsabilidad y propiedad. Sin SSN. ITIN o EIN aceptado. COI en 24h. Desde $120/mes.', url: `${BASE}/seguros/comercial`, siteName: 'Maria Fernanda Insurance Consulting', locale: 'es_US', type: 'website' },
