...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Protección Extra (Umbrella) para Hispanos | Maria Fernanda', description: 'Desde $1M de cobertura adicional. Protege tus ahorros. Desde $19/mes. Sin SSN requerido.', url: `${BASE}/seguros/proteccion-extra`, siteName: 'Maria Fernanda Insurance Consulting', locale: 'es_US', type: 'website' },
