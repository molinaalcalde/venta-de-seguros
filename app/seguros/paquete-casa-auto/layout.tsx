...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Paquete Seguro Casa + Auto para Hispanos | Aegis', description: 'Combina y ahorra hasta 25%. Sin SSN. Para inquilinos y dueños de casa. ITIN aceptado.', url: `${BASE}/seguros/paquete-casa-auto`, siteName: 'Aegis National Assurance', locale: 'es_US', type: 'website' },
