...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Seguro de Vida sin SSN — Living Benefits | Maria Fernanda', description: 'Para inmigrantes sin SSN. Acepta ITIN. Beneficiarios en México y cualquier país. Desde $45/mes.', url: `${BASE}/seguros/vida`, siteName: 'Maria Fernanda Insurance Consulting', locale: 'es_US', type: 'website' },
