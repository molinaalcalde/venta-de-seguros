...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Seguro de Auto sin SSN — ITIN Aceptado | Aegis', description: 'Asegura tu vehículo con ITIN, pasaporte o matrícula consular. Sin SSN. Desde $89/mes.', url: `${BASE}/seguros/auto`, siteName: 'Aegis National Assurance', locale: 'es_US', type: 'website' },
